        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 新增 <small>上机</small></div>
                    <p class="page-header-description">客户上机</p>
                </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">客户上机</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form " action="./addNewCord">
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">身份证号 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="recordid" name="recordid" placeholder="请输入身份证号码">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="recordname" name="recordname" placeholder="请输入姓名">

                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">上机位置 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="recordArea" name="recordArea" placeholder="请输入上机位置">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="lastmoney" name="lastmoney" placeholder="请输入充值金额">
...
<script>
    ...
    var  error1 ='<%=request.getParameter("new")%>';
    if (error1=='no'){
        alert("该机器已占用！");
    }
</script>
